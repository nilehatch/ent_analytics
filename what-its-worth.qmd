...
- At what price does this stop working? [The profit-reasoning chapter](profit-reasoning.qmd) drew that band, and its width is the whole reading.
- At what penetration of the reachable population? [The scale chapter](scale.qmd) made you do that one by hand, and the number is usually a shock.
- At what unit cost, or what size of commitment? Both move the same curve in different ways, and [the cost chapter](cost.qmd) separated them.
- And at what move by a competitor? [The differentiation chapter](differentiated-competition.qmd) gave you the equilibrium, and [the chapter on commitment](sequential-games.qmd) gave you the test for which of their moves would actually change yours.
...
Which is why the answer to the question on the cover is allowed to be *not yet*. [The chapter on commitment](sequential-games.qmd) named it and gave the reason: committing spends the option to wait, and that option is worth most precisely when you know least. A method that could only say yes or no would be hiding its most useful answer.
