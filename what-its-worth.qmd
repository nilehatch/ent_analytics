# What Your Estimate Is Worth {.unnumbered}
...
- At what price does this stop working? [Chapter 11](profit-reasoning.qmd) drew that band, and its width is the whole reading.
- At what penetration of the reachable population? [Chapter 9](scale.qmd) made you do that one by hand, and the number is usually a shock.
- At what unit cost, or what size of commitment? Both move the same curve in different ways, and [chapter 8](cost.qmd) separated them.
- And at what move by a competitor? [Chapter 13](differentiated-competition.qmd) gave you the equilibrium, and [chapter 19](sequential-games.qmd) gave you the test for which of their moves would actually change yours.
...
Which is why the answer to the question on the cover is allowed to be *not yet*. [Chapter 19](sequential-games.qmd) named it and gave the reason: committing spends the option to wait, and that option is worth most precisely when you know least. A method that could only say yes or no would be hiding its most useful answer.
