...
**Most urgent unknown** — the one unknown standing between you and the next decision, which is rarely the largest one on your list.
:::
...
::: {.column-margin .def-margin}
**Reducible uncertainty** — what is unknown only because nobody went and asked. Its opposite, irreducible uncertainty, will not resolve before you act whatever you spend on it.
:::
...
::: {.column-margin .def-margin}
**Entrepreneurial question** — one whose answer would change what you do, or raise your confidence in what you were already going to do.
:::
...
::: {.threshold}
**Before you go and gather evidence**

Everything after this chapter costs real time and other people's patience. Do not spend either until you can say four things in one breath.

- **What gets committed, and when.** Not "should we do this" but the lease, the batch, the hire. If you cannot name the thing you would sign, you are not yet facing a decision.
- **Who the customer is**, specifically enough that you could find one this week.
- **What one unit is** — the thing a buyer pictures themselves buying, in the period over which they decide again. A meal, this month. Not a share of revenue.
- **Which unknown is blocking you**, and whether it is demand. Sometimes it is regulatory, or technical, and this method will answer a question you were not asking.

If you cannot say all four, the survey you are about to write will produce answers to a question you have not settled.
:::
