...
**Check first that this is your layer.** It assumes you are pricing without a rival close enough to matter. If you can name a specific competitor, a customer choosing you is plausibly choosing them instead, and their price is visible to your customers, stop here and use [the method layer for a market with a rival](method-layer-competition.qmd) instead. The two run on different instruments and neither set of evidence converts into the other afterwards, so the choice has to be made before you field anything.
