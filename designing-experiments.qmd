...
> *What is the most you would pay for one unit, per period?*

This returns the boundary itself: the exact price at which that person's quantity moves from one to zero. One respondent, one point. Forty respondents, forty points, and the curve is built by counting rather than by fitting an assumption.
...
> 2. *What is the most you would pay for one unit?*
