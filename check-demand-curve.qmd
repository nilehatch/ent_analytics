---
subtitle: "Whether the curve you just fitted describes human beings"
---

# Sanity-Check Your Estimated Demand Curve {.unnumbered}

#### *A fast way to catch curves you shouldn’t trust*


This toolkit is a practical companion to [Chapter 8 Estimating Demand](estimating-demand.qmd). It does not explain how to operate the [profit analytics app](https://rconnect.byu.edu/ProfitAnalytics). It explains how to interpret the results it produces
