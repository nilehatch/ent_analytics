...
Chapter 1 put the argument of this book on one line, and every chapter since has been about one of its terms:

$$ \mathsf{\pi = pq - cq - f} $$

Price times quantity, less what each unit costs, less what you committed before anyone bought. The last chapter turned that into a picture you could read for feasibility, fragility and robustness. Written as a function of the one thing you choose, it is

$$ \mathsf{\pi(p) = (p - c)\,q - f} $$

Under rivalry it takes a second argument:
