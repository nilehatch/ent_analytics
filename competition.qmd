...
[^bertrand]: This argument is old and it is not mine. Joseph Bertrand made it in 1883, reviewing Cournot, and the model of price competition that follows from it carries his name [@bertrandBookReviewEmphRecherche1883]. The next chapter is the version where products differ.
...
[^dispersion]: What a price-comparison platform does to the spread between sellers has been studied directly; @bayePriceDispersionSmall2004 is the place to start. Being findable and being comparable are the same thing on such a platform, and comparability is what compresses margin. Orders keep coming and contribution keeps shrinking.
