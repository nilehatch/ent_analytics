...
subtitle: "What changes when somebody else is selling too"
...
#| warning: false
#| message: false
#| fig-cap: "Profit curves holding the rival’s price fixed at three different levels. The best price shifts as the rival’s price changes."
#| cap-location: margin
...
#| warning: false
#| message: false
#| fig-cap: 'Many profit curves across rival prices. Together, they form the profit surface $\mathsf{\pi(P_i, P_j)}$.'
#| cap-location: margin
