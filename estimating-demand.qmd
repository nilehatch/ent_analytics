...
${nresp} respondents. The first twelve are the real answers from the table above;
the rest are simulated from the same shape, to show what more evidence would do
to the staircase.</p>`
```
