---
subtitle: "From a sample of respondents to a population you can reach"
---

# Making Scale Explicit {.unnumbered}
...
Demand is almost always learned from a **sample**.
Costs—especially fixed costs—are usually incurred to serve a **population**.

Scale is what connects those two facts.

This toolkit exists to make that connection explicit.

It does not ask you to forecast growth.
...
Sometimes the answer points to a small, self-sustaining venture.
Sometimes it suggests a staged path toward larger commitments.
Sometimes it reveals a design that only works at scale.
...
This toolkit supports the transition from cost to [profit reasoning](profit.qmd).
...
That is not a modeling trick.
It is a consequence of taking commitments seriously.

Fixed costs—large or small—are not artifacts to be allocated.
They are decisions that define the scale at which the venture must work.
