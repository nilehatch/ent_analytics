...
The agency in the last chapter sold **reach**: a campaign that told more people ice cream sandwiches existed, and brought two units per person per month of new consumption into the market. Whoever bought it grew the pool.

Now suppose a different agency sells **comparative** advertising. Not *ice cream sandwiches are good*, but *ours are better than theirs*. This campaign does not tell anybody anything new about the category. It moves two units per person from the rival's column into yours, and nothing else changes.

Same firms. Same estimated demand system. Same two units. The only difference is where the two units come from.
...
Unilaterally, though, the campaign works. Hogi Yogi alone gains more than a dollar of gross contribution, and Smart Cookie alone gains thirty-eight cents. Each firm, looking at its own decision, sees a real gain.
...
For both firms to buy, the gain has to exceed the cost in every situation. The smallest of those gains is Smart Cookie's thirty-three cents when Hogi Yogi is already advertising. So the campaign has to cost **less than about thirty-three cents** before both firms want it regardless of what the other does.

At the seventy-five cents the last chapter's agency charged, nobody buys this one. Smart Cookie declines, Hogi Yogi declines, and the comparative campaign never happens. The expensive poaching campaign is not a trap because it is not tempting.
...
#| label: tbl-dilemma
#| echo: false
#| tbl-cap: "The same comparative campaign priced at $0.25. Advertising is now the better choice for each firm whatever the other does, and both end up exactly $0.25 poorer than if neither had bought it."
...
Work through it the way the last chapter did. Smart Cookie earns \$1.33 sitting still against a passive rival and \$1.46 by advertising; \$0.99 against an advertising rival and \$1.08 by advertising. Better both times. Hogi Yogi finds the same thing.

So both advertise. Both are behaving correctly. And the equilibrium leaves Smart Cookie at \$1.08 against the \$1.33 it would have had, and Hogi Yogi at \$0.71 against \$0.96 — each exactly twenty-five cents poorer, which is exactly what the campaign cost.
