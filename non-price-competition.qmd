...
Return to Smart Cookie and Hogi Yogi, whose estimated demand system [the chapter on advantage](competitive-advantage.qmd) already put on the table.
...
That result is not a quirk of these numbers. It follows directly from the asymmetry [the differentiation chapter](differentiated-competition.qmd) made the center of the argument.
...
That is the assumption [the chapter on price competition](competition.qmd) dismantled at length, and there is no reason it should survive here. Advertising agencies sell to whoever will buy. If the campaign is available to Hogi Yogi it is almost certainly available to Smart Cookie, and Smart Cookie can do the same arithmetic.
