...
Usually, and not always, and the exceptions are worth knowing because they point at which kind of cost advantage to build. A cost advantage that comes from what an organization has *learned* behaves very differently from one that comes from what it *bought*, and the difference has been measured for decades: learning persists within a plant far better than it transfers between them [@argotePersistenceTransferLearning1990]. Semiconductor plants that invested in the human capital of their operators moved down the learning curve faster and held the resulting cost advantage, and it did not transfer to rivals even when the operators themselves did, because much of what those people knew was specific to that plant and did not travel with them [@hatchHumanCapitalLearning2004]. Toyota's production advantages were similarly slow to reach its American rivals even where the same suppliers were building parts for both, in the same buildings, because the advantage lived in the relationships rather than in the equipment [@dyerRelationSpecificCapabilititesNetwork2006].
...
We have some evidence on how much removing it is worth. In simulated entry decisions where two innovators each chose whether to enter a differentiated market, the entrants were grouped by how they represented the competition to themselves.^[For details, see @hatchPerformanceEffectsCompeting2018.] Those who always entered when demand looked positive did worst. Those who considered market size but ignored rivalry did better. Those who represented rivalry structurally did better again. More elaborate strategic machinery on top of that helped, but the incremental gain beyond disciplined competitive reasoning was modest.

The practical reading is encouraging. You do not need game theory to make good entry decisions. You need to represent the competition as something that responds, estimate the parameters, and compute where the market settles. That is what the last four chapters have been teaching, and it captures most of what sophistication buys.
