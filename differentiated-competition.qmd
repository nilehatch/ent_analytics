...
Smaller d reflects stronger differentiation between products; larger d reflects stronger substitution and more intense rivalry.
...
In [Chapter 13 Competition](competition.qmd), we visualized profit as a surface.
...
This moves us back toward the undifferentiated collapse of [Chapter 14 When Price Competition Eliminates Profit](undifferentiated-competition.qmd).
...
[Chapter 17 Competitive Profit and Structural Advantage](competitive-advantage.qmd) explores what happens when firms are structurally different. That is where competitive advantage appears.
...
- Monopoly without rivals ([Chapter 12](profit-reasoning.qmd))
- Undifferentiated collapse ([Chapter 14](undifferentiated-competition.qmd))
...
- Substitution intensity (the size of $\mathsf{d}$)
- Price sensitivity (the size of $\mathsf{b}$)
- Unit variable cost (the size of $\mathsf{c}$)

Smaller substitution intensity reflects stronger differentiation between products.  
...
::: {.callout-tip collapse="true" icon = "false"}
## Substitution Intensity [optional math note]
...
When substitution intensity is weak (small $\mathsf{d}$), differentiation is also weak and equilibrium price is relatively low.  
...
d_vals <- seq(0.1, 2, length.out = 200)
...
As substitution intensity $\mathsf{d}$  approaches $\mathsf{2b}$, pricing becomes highly interdependent and equilibrium price rises sharply. Structural insulation from pure price competition becomes decisive.
