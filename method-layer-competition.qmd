...
- **Quantity at condition 1 should be the largest** for each respondent — everything is free there. A respondent whose maximum is elsewhere misread the scenarios.
...
- each respondent's quantity is highest when both products are free
