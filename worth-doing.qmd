---
subtitle: "The decision you have to make before the numbers exist"
---

# Is This Worth Doing? {.unnumbered #sec-worth-doing}
...
**$\mathsf{\pi}$** — the Greek letter *pi*, used here and everywhere after it to mean **profit**. It is not 3.14. Economists borrowed the letter because *profit* starts with a p sound, and the convention stuck. The other four letters are $\mathsf{p}$ for price, $\mathsf{q}$ for quantity, $\mathsf{c}$ for the cost of one unit, and $\mathsf{f}$ for fixed cost.
:::
...
::: {.reflect}
**Ask yourself — where is your own q?**

Take the decision you brought to this book and write down four things.

The price you would charge. That is $\mathsf{p}$, and you just chose it in a few seconds.

What one unit costs you to make and deliver. That is $\mathsf{c}$. Estimate it if you have to; the point is that you could find out this afternoon.

What you must spend before anyone buys anything at all. That is $\mathsf{f}$, and you chose the size of it.

Now the quantity. Notice that you cannot write it, and that no amount of thinking will produce it. If you wrote a number anyway, ask where it came from: evidence, or the figure the arithmetic needed in order to work.
:::

::: {.key-action}
**The move:** Three of the four terms are already yours. Spend your effort on the one that is not.
:::

That last question is the uncomfortable one, and most people have never been asked it. The reason has less to do with carelessness than with the instruments everyone is handed, which turn out to have been built by people who already knew their quantity, or who never needed to.
