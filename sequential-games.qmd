...
tibble::tibble(
  ...
  gt() |>
  tab_options(table.font.size = 12, data_row.padding = px(6), table.width = pct(100)) |>
  cols_align("center") |>
...
tibble::tibble(
  ...
  gt() |>
  tab_options(table.font.size = 12, data_row.padding = px(9), table.width = pct(100)) |>
  cols_align("center") |> cols_align("left", columns = `If the equipment costs`)
```
...
ggplot() +
  ...
  geom_text(data = lab, aes(mx, ly, label = txt, alpha = ok),
            size = 3.2, color = itwd_muted) +
  geom_text(data = leaf, aes(x + 0.10, y, label = t, alpha = ok),
            hjust = 0, size = 3.9, color = itwd_ink) +
...
tibble::tribble(
  ...
  gt() |>
  tab_options(table.font.size = 12, data_row.padding = px(7), table.width = pct(100)) |>
  cols_align("left")
```
