...
That is the first move in this whole part that takes something from the other firm, and the reason is a number from [chapter 12](differentiated-competition.qmd). Smart Cookie's demand responds to Hogi Yogi's price with a coefficient of 5.57, the largest in the system. Smart Cookie is enormously exposed to what Hogi Yogi charges. Neither kind of advertising reached that exposure; a cost cut goes straight at it.
...
What the cheaper equipment does not buy is a position. Both firms end at low cost, neither holds anything the other lacks, and the structural asymmetry that [chapter 14](competitive-advantage.qmd) called the whole of competitive advantage has been competed away in a single round. At twenty-two cents Hogi Yogi is the only low-cost firm in the market and remains so while the equipment stays expensive.
...
[Chapter 14](competitive-advantage.qmd) defined an entry barrier as structural asymmetry large enough to make an entrant's equilibrium profit negative, and observed that an incumbent investing in visible capacity or signalling low cost is not frightening anybody — it is changing their forecast. That is this chapter's test with one substitution. The rival's move is *enter*, and the commitment works if it changes that move to *do not*.
...
Recall the simulated entry decisions from [chapter 14](competitive-advantage.qmd), where each firm held some representation of its market and its rival. Two results land directly on this chapter.^[@hatchCognitiveExposureHow2026, under revision.]
