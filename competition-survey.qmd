---
subtitle: "Designing a survey that estimates demand against a rival"
---

# Toolkit III: Competition {.unnumbered}
...
It assumes you have already completed [Toolkit — Framing a Demand Learning Problem](frame-the-problem.qmd), including:
...
If those elements are not yet clear, return to the [problem framing toolkit](frame-the-problem.qmd) before proceeding.
...
The structure closely mirrors the [survey design used for monopoly demand](survey-design.qmd). The key difference is that respondents must evaluate *two products at the same time*, allowing substitution effects to be measured.
...
1. **Price A = 0**, **Price B = 0**
2. **Price A = WTP A**, **Price B = 0**
3. **Price A = 0**, **Price B = WTP B**
4. **Price A = WTP A**, **Price B = WTP B**

:::

Example prompts:

> 1. If Product A were permanently free and Product B were also permanently free, how many units of Product A would you buy per \[period\]?\
> 2. If Product A cost \$\[WTP A\] and Product B were free, how many units of Product A would you buy?\
> 3. If Product A were free and Product B cost \$\[WTP B\], how many units of Product A would you buy?\
> 4. If Product A cost \$\[WTP A\] and Product B cost \$\[WTP B\], how many units of Product A would you buy?
