---
subtitle: "Checks that tell you whether the data deserves your confidence"
---

# Validating and Stress-Testing Demand Evidence {.unnumbered}
...
- completed the [problem framing toolkit](frame-the-problem.qmd),
- designed and executed a survey using the [survey design toolkit](tk2_survey_design),
- and generated an initial demand estimate or curve using the [profit analytics app](https://rconnect.byu.edu/ProfitAnalytics).
